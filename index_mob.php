<?php
//include_once $_SERVER['DOCUMENT_ROOT'].'/roger/pdf/tcpdf/config/lang/functions.php';
...
if(!$purl) { 
    	...
    	<div class='adresa'>Barcelona<br>Pl. universitat 4. 3r 2a<br>08007 Barcelona<br>T 934 410 100<br>T 654 534 354<br><br><a href='mailto:info@lamosca.com'>info@lamosca.com</a></div>
    	<div class='feis'><a href='http://www.facebook.com/pages/Lamosca/173103592720207' target='_blank'><img src='".$imgroot."index/facebook.gif' width='16' height='16' border='0' alt='' />VISIT US ON FACEBOOK</a></div>
    	</div>
    	<br /><br />\n";
}
?>
...
<?php
	...
	if(!$purl) {
		echo "   <div class='pageSponsor'><a href='http://www.promsite.org./' target='_blank'><img src='".$imgroot."index/cdmon2.gif' width='71' height='42' border='0' alt='Patrocinat per Cdmon' /></a></div>\n"; 
	}
?>
  </div>
